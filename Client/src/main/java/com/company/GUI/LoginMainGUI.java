...
public class LoginMainGUI extends JFrame {
    ...
    public LoginMainGUI() throws IOException {
        super("Login");
        setSize(300, 200);
        setResizable(false);
    ...
    private void sendSignupRequest() throws IOException {
        SignupGUI signupGUI = new SignupGUI(client, this);
    ...
    private void sendLoginRequest() throws IOException {
        ...
        if (client.login(user, pass)) {
            ...
            jFrame.addWindowListener(mainGUI);
    ...
    public static void main(String[] args) throws IOException {
        LoginMainGUI loginMainGUI = new LoginMainGUI();
