...
public class FileTransferThread extends Thread {
    ...
    public FileTransferThread(String sender, String receiver,String host, int port, String file, InboxGUI inboxGUI)
    {
    ...
    public void run() {
        try{
            ...
            JOptionPane.showMessageDialog(inboxGUI, "Send file successful.!");
